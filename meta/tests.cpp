...
void launchTest(int time_max){
    ...
    for(auto filename:filesTest){
        ...
        int nb_iter_small_tabou = 1000;    //2000
        int nb_iter_diversification = 1000; //5000
        for(int i=0;i<5;i++)
        metaheuristique_bis(filepath_sol, g, time_max, normal_tabou, long_tabou, small_tabou,
        nb_iter_diversification, nb_iter_long_tabou, nb_iter_diversification, nb_iter_small_tabou); 
    }
}
